...
public class CommonUtilsTest {
    ...
    public static void Commons() {
        ...
        //这个有意思，二三参数对应的数组，查找二参数数组一样的值，替换三参数对应数组的值。
        ...
        //如果字符串长度小于参数二的值，末尾加空格补全。(小于字符串长度不处理返回)
        ...
        //转换,刷选~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        //转换第一个字符为大写.如果第一个字符是大写原始返回
        System.out.println(StringUtils.capitalize("Ddf"));

        //转换第一个字符为小写.如果第一个字符是小写原始返回
    ...
    private static String[] getArrayData() {
        return (String[]) getListData().toArray(new String[getListData().size()]);
    }
